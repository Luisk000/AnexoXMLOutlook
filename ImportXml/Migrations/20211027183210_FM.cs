        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nfeProc_NFe_infNFe_ide_cUF = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_ide_mod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_serie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_nNF = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_ide_tpNF = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_idDest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_cMunFG = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_tpImp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_tpEmis = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_cDV = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_tpAmb = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_finNFe = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_indFinal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_indPres = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_indIntermed = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_ide_procEmi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_emit_enderEmit_nro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_emit_CRT = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_dest_enderDest_nro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_dest_indIEDest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_retirada_nro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_entrega_nro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_total_ICMSTot_vBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vICMS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vICMSDeson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vFCPUFDest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vICMSUFDest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vICMSUFRemet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vFCP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vBCST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vFCPST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vFCPSTRet = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vProd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vFrete = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vSeg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vDesc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vII = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vIPI = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vIPIDevol = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vPIS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vCOFINS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vOutro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vNF = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_ICMSTot_vTotTrib = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_transp_modFrete = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_total_transp_vol_qVol = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_transp_vol_marca = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_transp_vol_pesoL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_transp_vol_pesoB = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_cobr_fat_nFat = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_cobr_fat_vOrig = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_cobr_fat_vDesc = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_cobr_fat_vLiq = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_total_cobr_dup_vDup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_pag_detPag_indPag = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_pag_detPag_tPag = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_total_pag_detPag_vPag = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_protNFe_infProt_tpAmb = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_protNFe_infProt_cStat = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    XmlFileId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    nfeProc_NFe_infNFe_det____nItem = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_cProd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_det_prod_CFOP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_uCom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_qCom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_vUnCom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_vProd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    nfeProc_NFe_infNFe_det_prod_qTrib = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_vUnTrib = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_prod_indTot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMSN102_orig = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMSN102_CSOSN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_orig = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_modBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_vBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_pICMS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_ICMS_ICMS00_vICMS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_cEnq = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_IPINT_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_IPINTrib_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_IPINTrib_vBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_IPINTrib_pIPI = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_IPI_IPINTrib_vIPI = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_PIS_PISNT_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_PIS_PISAliq_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_PIS_PISAliq_vBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_PIS_PISAliq_pPIS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_PIS_PISAliq_vPIS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSNT_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_CST = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_vBC = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_pPIS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_vPIS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_pCOFINS = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nfeProc_NFe_infNFe_det_Imposto_COFINS_COFINSAliq_vCOFINS = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
